...
# GO-protein
GO_MF = np.loadtxt(r"./GO_uniprot/GO_MF_9071.csv", dtype=object, delimiter=",", skiprows=1)
GO_BP = np.loadtxt(r"./GO_uniprot/GO_BP_18737.csv", dtype=object, delimiter=",", skiprows=1)
GO_CC = np.loadtxt(r"./GO_uniprot/GO_CC_9990.csv", dtype=object, delimiter=",", skiprows=1)
# GO-sim
MF_sim = np.loadtxt(r"./GO_sim/MF_sim_1849.csv", dtype=object, delimiter=",", skiprows=1)
BP_sim = np.loadtxt(r"./GO_sim/BP_sim_5199.csv", dtype=object, delimiter=",", skiprows=1)
CC_sim = np.loadtxt(r"./GO_sim/CC_sim_744.csv", dtype=object, delimiter=",", skiprows=1)
