...
# data_types = ["neg3_9/neg3_9/", "neg-b3_9/neg-b3_9/"]
...
# GO terms
MF_terms = np.loadtxt(r"./GO/GO/GO_terms/MF_terms_1849.csv", dtype=object, delimiter=",", skiprows=1)
BP_terms = np.loadtxt(r"./GO/GO/GO_terms/BP_terms_5199.csv", dtype=object, delimiter=",", skiprows=1)
CC_terms = np.loadtxt(r"./GO/GO/GO_terms/CC_terms_744.csv", dtype=object, delimiter=",", skiprows=1)
